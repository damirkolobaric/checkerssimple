...
class GameViewController: UIViewController {
    ...
    func addControlButtons() {
        ...
        soundButton.titleLabel?.font = UIFont.systemFont(ofSize: 24)
        ...
        musicButton.titleLabel?.font = UIFont.systemFont(ofSize: 24)
        ...
        turnLabel.backgroundColor = UIColor.black.withAlphaComponent(0.5)
